// Package cli implements the go-modularity command, which computes type-level and package-level modularity
...
// Run executes go-modularity with args and returns its process exit code.
